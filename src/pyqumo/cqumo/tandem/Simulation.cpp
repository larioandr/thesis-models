...
NodeData::NodeData(const NodeJournal &records)
    ...
    lossProb = numPacketsProcessed != 0 ? static_cast<double>(numPacketsLost) /
                                          numPacketsProcessed : 0.0;
    dropProb = numPacketsArrived != 0 ? static_cast<double>(numPacketsDropped) /
                                        numPacketsArrived : 0.0;
...
std::string NodeData::text(const std::string &prefix) const {
    ...
    ss << prefix << "- numPacketsGenerated: " << numPacketsGenerated
       << std::endl;
    ss << prefix << "- numPacketsDelivered: " << numPacketsDelivered
       << std::endl;
